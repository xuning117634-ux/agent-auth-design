...
> 最后更新：2026-06-11
> 阅读顺序：5-01
> 文档职责：说明业务后端与业务 Agent 如何接入当前 Agent 动态授权安全方案。策略中心接口字段以 [策略中心对外接口参考](../02-policy-center/08-external-api-reference.md) 为准。
...
- 页面只能让用户确认或拒绝本次对话授权，不展示 7 天、30 天或跨对话授权选项。
